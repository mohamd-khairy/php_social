...
$ProfileBox = userModel::get_Data_by_id($UserId);
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 pull-right">
                <div class="card card-user">
                    ...
                    <div class="image">
                        ...
                        ?>
                        <img style="height: 100%" src="<?= HostName . DS . "assets/img/" . $i ?>" />
                    </div>
                    <div class="content">
                        <div class="author">
                            <?php
            ...
            <?php if ($UserId == $_SESSION['u_id']) { ?>      
                ...
                <div class=" col-sm-12 col-xs-12 col-lg-8  col-md-12 pull-left">
                    <div class="card">
                        <div class="header">
                            <div class="row">
                                <div class="text-center">
                                    <a href="?rt=HomePage/updateProfile&id=<?= $UserId ?>" type="submit"  class="btn btn-default  btn-wd"><i class="ti-pencil" ></i> Update Profile</a>
                                </div>
                                <br>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 pull-left" id="lastPost" style="display: none">
                    <div class="card">
                        <div class="header">
                            <div class="row">
                                ...
                                <div class="col-xs-2 text-right">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <form id="last_post" method="post" action="index.php?rt=PostController/like_last_post">
                                            <input type="hidden" id="p_last_id" ></form>
                        ...
                        <div class="content">
                            ...
                            <div class="footer">
                                ...
                                <div class="chart-legend" >
                                    <i class="fa fa-circle text-info"></i> <a onclick="$('#last_post').submit()" href="#" style="color: black;">Like</a>
...
<script>
    ...
    function deletePost(id) {
        $.post('?rt=PostController/deletePost', {u_id: id}, function (res) {
//            alert(res);
        });
    }
